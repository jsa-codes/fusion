// ➡️ ALGORITHM
// Create a function called boatInventory that has no parameters.
// It creates an array of fish objects with the following properties:
//      -id, -species, -weight, -price, -amount
const boatInventory = () => {
  const freshFish = [
